...
Args:
  _in_feats: tensor of shape [B, IC];                   //> FP16
  _kernel: int tensor of shape [OC, IC // 8];           //> INT4
  _zeros: int tensor of shape [OC, IC // G // 8];       //> INT4
  _scaling_factors: tensor of shape [OC, IC // G];      //> FP16
...
Returns:
  out_feats: tensor of shape [B, OC]; //> FP16
*/
torch::Tensor dense_layer_gemm_w4a16(
